...
void Hardware::PrintAllControls() {
  ...
  Log::PrintLine("\tSW1: %s\tSW2: %s\tSW3: %s", sw1_str,
                 sw2.Pressed() ? "R" : "L", sw3.Pressed() ? "R" : "L");
  Log::PrintLine("\tSW4: %s\tSW5: %s", sw4.Pressed() ? "X" : "O",
                 sw5.Pressed() ? "X" : "O");
  Log::PrintLine("\tFSW1: %s\tFSW2: %s", fsw_1.Pressed() ? "X" : "O",
                 fsw_2.Pressed() ? "X" : "O");
  ...
  Log::PrintLine("\tVR4: " FLT_FMT3 "\tVR5: " FLT_FMT3 "\tVR6: " FLT_FMT3,
                 FLT_VAR3(pot[3].Value()), FLT_VAR3(pot[4].Value()),
