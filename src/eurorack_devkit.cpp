...
void Hardware::Init()
{
    ...
    adc_config[0].InitMux(
        seed::D15, 8, seed::D24, seed::D25, seed::D26, conversion_speed);
...
void Hardware::PrintAllControls()
{
    ...
    Log::PrintLine("\tGate In 1: %s\tGate In 2: %s",
                   gate_in1.State() ? "X" : "O",
                   gate_in2.State() ? "X" : "O");
    Log::PrintLine("------ADCs------");
    ...
    Log::PrintLine("\tVR5: " FLT_FMT3 "\tVR6: " FLT_FMT3 "\tVR7: " FLT_FMT3
                   ...
                   FLT_VAR3(pot[6].Value()),
                   FLT_VAR3(pot[7].Value()));
